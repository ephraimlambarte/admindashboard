      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <div class="sidebar-header d-flex align-items-center">
            <div class="avatar"><img src="../images/ephraim2.jpg" alt="..." class="rounded-circle" style = "width:50px;height:50px;"></div>
            <div class="title">
              <h1 class="h4">Ephraim Lambarte</h1>
              <p>Web Designer</p>
            </div>
          </div>
